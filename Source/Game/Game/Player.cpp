...
void Player::Update(float dt)
{
	...
	if(viper::getEngine().getInput().GetMouseButtonPressed(viper::InputSystem::mouseButton::Left) && fireTimer <= 0) {
		fireTimer = fireTime;
		std::shared_ptr<viper::Model> model = std::make_shared<viper::Model>(GameData::rockect, viper::vec3{ 1.0f, 1.0f, 1.0f });
